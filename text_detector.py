...
ap.add_argument("-i", "--image", type=str, default="images/plates/PLACARD-PT017A9-1584459451-0.jpg",
...
for (startX, startY, endX, endY) in boxes:
    ...
    text_images.append(gray[startY-d:endY+d, startX-d:endX+d])
